...
def get_vectorstore_from_url(url):
   ...
   documnet_chunks = text_splitter.split_documents(document)

   #create vectorstore from chunks
   vector_store = Chroma.from_documents(documnet_chunks,OpenAIEmbeddings())
...
if website_url is None or website_url == "":
 ...
 if "chat_history" not in st.session_state:
   st.session_state.chat_history = [ 
    AIMessage(content = "helllo, I am a bot. How can i help you?"),
  ] 
